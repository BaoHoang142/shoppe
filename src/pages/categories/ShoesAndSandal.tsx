...
import SlideShoesManFaShion from "../slide/SlideShoesManFashion";
interface Product {
  productId: number;
  productName: string;
  price: number;
  ...
  const getProduct = async () => {
    try {
      const res = await axios.get(
        `http://localhost:8080/api/v1/products/category/${6}`
      );
